...
var SxManageToolbar = React.createClass({
    ...
    getInitialState: function(){
        return{
            toolbars: Immutable.fromJS(this.props.toolbars),
    ...
    render: function(){ 
    	return <SxBox className="sx-manage-bar" isPadding = { false } isMargin = { false }
         isRow = { true } isCenter = {true} isMiddle = {true}>
            { this.renderButtons() }
            { this.renderManage() }
        </SxBox>
    }
