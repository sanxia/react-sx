...
class SxListView extends Component{
    ...
    onRenderSectionHeader(sectionIndex){
        ...
        if(this.props.onRenderSectionHeader){
            sectionHeader = this.props.onRenderSectionHeader(sectionIndex)
        }
    ...
    onRenderSectionFooter(sectionIndex){
        ...
        if(this.props.onRenderSectionFooter){
            sectionFooter = this.props.onRenderSectionFooter(sectionIndex)
        }
    ...
    renderRow(sectionIndex, rowIndex){
        ...
        let isLastSection = rowIndex == sectionCount - 1
        ...
        if(sectionCount > 1 && !isLastSection && this.state.isSepratorLine && !this.props.onRenderCellHeading){
            rowClass += " sx-line-b"
        }
    ...
    renderCellHeading(sectionIndex, rowIndex, columnIndex){
        ...
        if(this.props.onRenderCellHeading){
            heading = this.props.onRenderCellHeading(sectionIndex, rowIndex, columnIndex)
        }
    ...
    renderCell(sectionIndex, rowIndex, columnIndex){
        ...
        let cellContentClass = "sx-box sx-box-r sx-box-rsb sx-box-css sx-box-f sx-list-cell-content"

        if(sectionCount > 1 && !isLastSection && this.state.isSepratorLine){
