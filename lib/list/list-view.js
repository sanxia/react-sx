...
var SxListView = React.createClass({
    ...
    getInitialState: function(){
        return{
            ...
            sectionField: this.props.sectionField,
    ...
    setSectionName: function(sectionField){
    ...
    onRenderSectionHeader: function(sectionIndex, sectionTitle, childs){
        let sectionHeader = ""
    ...
    onRenderSectionFooter: function(sectionIndex, sectionTitle, childs){
        let sectionFooter = ""
    ...
    renderRow: function(index, childs, groupCount){
        ...
        let isSepratorLine = false
        if(rowClass != ""){
            isSepratorLine = true
        }

        return <SxBox key = { index } isRow = { false } isCenter = { true } isPadding = { false } className = { rowClass }>
            { rowHeader }

            <SxBox isRow = { true } isCenter = { true } isPadding = { false } isStretch = { true } className = "sx-list-row-content">
            {
                childs.map((v,k)=>{
                    return this.renderCell(index, k, v, groupCount)
                })
            }
            </SxBox>
    ...
    renderCellHeading: function(row, column, item){
        let heading = ""
    ...
    renderCell: function(row, column, item, groupCount){
        let content = ""
    ...
    renderCellTailing: function(row, column, item){
        let tailing = ""
