...
class SxMarkdown extends Component{
    ...
    getEditor(){
        ...
        $.getScript("http://res.woshiyiren.com/static/js/md/md.js", function() {   
                ...
                onload : function(){
                    this.config({
                        ...
                        toolbarIcons : function() {
                            return ["fullscreen", "|", "bold", "italic", "hr", "quote", "|", "link", "image", "||", "preview", "publish"]
                        },
    ...
    render = ()=>{
        ...
        let title = info == "" ? "" : <span dangerouslySetInnerHTML = {{__html: info}} className = "sx-title" onClick = { (e)=>this.onMouseOver(e) } />
        if( this.props.isRequire && info != "" ){
            info += "<i>*</i>"
            title = <p dangerouslySetInnerHTML = {{__html: info}} className = "sx-title" onClick = { (e)=>this.onMouseOver(e) } />
        }
