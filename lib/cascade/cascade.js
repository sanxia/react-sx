...
var SxCascade = React.createClass({
    ...
    onHeading: function(index, data){
        if(this.props.onHeading){
            return this.props.onHeading(index, data)
        }
        return ""
    },

    onTailing: function(index, data){
        if(this.props.onTailing){
            return this.props.onTailing(index, data)
        }
        return ""
    },
    ...
    onBinding: function(data) {
        ...
        if(this.props.onBinding){
            if ( this.props.onBinding({ index: data.index, value: newValue.toJS() }) ){
    ...
    render: function() {
        ...
        return <div className = { className } onMouseOver = { this.onMouseOver } onMouseOut = { this.onMouseOut }>
                ...
                {
                    this.props.children ? 
                    <div className = "sx-cascade-ext">{ this.props.children }</div>
                    :
                    ""
                }
        </div>
