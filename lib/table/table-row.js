...
var SxTableRow = React.createClass({
    ...
    render: function() {
        ...
        let trClassNames = classNames({
                ...
                "grx-table-first-row": isFirstRow
            },{
                "grx-table-last-row": isLastRow
            },{
                "grx-selectable-item": true
            },{
                "grx-disabled-item": !isEnabled && !isChecked && !isActive
            },{
                "grx-selected-item": isChecked && !isActive
            },{
                "grx-active-item": isActive
            }
        )
