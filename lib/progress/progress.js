...
class SxProgress extends Component {
    ...
    renderTitle = ()=>{
        if(this.state.title){
            return <div className = "sx-box sx-box-csc sx-box-rsc sx-box-f sx-progress-text">
                { this.state.title }
            </div>
        }
    ...
    render = ()=>{
        ...
        return <div ref = { (progress)=>this.progress = progress } className = { progressClass } style = { progressStyle }>
