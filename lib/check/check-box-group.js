...
var SxCheckBoxGroup = React.createClass({
    ...
    checkOption: function(options, value){
        ...
        //自动绑定值处理
        this.props.onValue({isChecked: isChecked, options: options.toJS(), value: checkValue.toJS()})
    },
    ...
    onSelectChange: function(value) {
        ...
        if(this.props.onValue){
            if(this.props.onValue({isChecked: value.isChecked, options: options.toJS(), value: optionValues.toJS()})){
