...
class SxListCell extends Component{
    ...
    renderTitle(){
        ...
        if(title != ""){
            content = <dt className = "sx-box sx-box-r sx-box-rsb sx-box-csc sx-box-w sx-mb5">
                { title }
            </dt>
        }
    ...
    renderContent(){
        ...
        if(info != ""){
            content = <dd className = "sx-box sx-box-c sx-box-css sx-box-rsl sx-box-w sx-txt-content">
                { info }
            </dd>
        }
