...
class SxListCell extends Component{
    ...
    renderTitle = ()=>{
        ...
        if(title){
            return <dt className = "sx-box sx-box-r sx-box-rsb sx-box-w">
                { title }
            </dt>
        }
    ...
    renderSubtitle = ()=>{
        ...
        if(subtitle){
            return <dd className = "sx-box sx-box-r sx-box-rsb sx-box-w">
                { subtitle }
            </dd>
        }
    ...
    render = ()=>{
        let cellClassName = "sx-box sx-box-r sx-box-rsb sx-box-f"
        ...
        if(this.props.isCenter){
            cellClassName = cellClassName + " sx-box-csc"
        }
